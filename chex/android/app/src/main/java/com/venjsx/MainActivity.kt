...
class MainActivity : AppCompatActivity() {
  ...
  // The bridge type keeps its legacy name internally; Chex is the public API.
  private var chexEngine: VenjsXEngine? = null
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    chexEngine = VenjsXEngine(this, nativeRoot!!, bridgeWebView!!)
    bridgeWebView!!.addJavascriptInterface(chexEngine!!, "Android")
    chexEngine?.handleNotificationTapFromIntent(intent)
    ...
    onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
      override fun handleOnBackPressed() {
        ...
        webView.evaluateJavascript(
          "(function(){try{var h=window.__chexHandleNativeBack||window.__venjsHandleNativeBack;return (h&&h())?'1':'0';}catch(e){return '0';}})();"
        ) { result ->
  ...
  override fun onRequestPermissionsResult(
    ...
    chexEngine?.onRequestPermissionsResult(requestCode, permissions, grantResults)
