...
`js/Chex.js` is the canonical runtime source. The CLI keeps the native shells’ runtime copies in sync automatically:
- Android: `android/app/src/main/assets/js/Chex.js`
- iOS: `ios/app/js/Chex.js`
